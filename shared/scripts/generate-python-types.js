// Script to generate Python dataclasses from TypeScript types
import fs from 'fs';
...
// Write the Python types file
const outputPath = path.join(pythonDir, 'types.py');
fs.writeFileSync(outputPath, pythonTemplate);

// Create __init__.py
const initPath = path.join(pythonDir, '__init__.py');
fs.writeFileSync(initPath, 'from .types import *\n');
